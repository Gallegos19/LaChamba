...
import DropdownOptions from "../../components/DropdownOptions/DropdownOptions"; // Importamos el componente DropdownOptions
  ...
  return (
    <div className={style.containerNav}>
      ...
      <div className={`${style.menu} `}>
        <a className={style.a} onClick={() => handleMenuToggle("caballero")}>Caballero</a>
      ...
      <div className={`${style.menu}`}>
        <a className={style.a} onClick={() => handleMenuToggle("dama") }>Dama</a>
        {activeMenu === "dama" && <DropdownOptions options={optionsData.dama} onClick={navigate} />}
      </div>

      <div className={`${style.menu} `}>
        <a className={style.a} onClick={() => handleMenuToggle("ninos")}>Niños</a>
        {activeMenu === "ninos" && <DropdownOptions options={optionsData.ninos} onClick={navigate} />}
      </div>

      <div className={`${style.menu} `}>
        <a className={style.a} onClick={() => handleMenuToggle("otros")}>Otros</a>
        {activeMenu === "otros" && <DropdownOptions options={optionsData.otros} onClick={navigate} />}
      </div>
